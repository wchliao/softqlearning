...
class SingleGoalEnv(Env, Serializable):
    """
    ...
    Action: velocity.
    """
    def __init__(self, goal_position=None, goal_reward=10, actuation_cost_coeff=30,
                 distance_cost_coeff=1, init_sigma=0.1):
        super(SingleGoalEnv, self).__init__()
        ...
        if goal_position is None:
            goal_position = [5, 0]
        self.goal_positions = np.array([goal_position], dtype=np.float32)
